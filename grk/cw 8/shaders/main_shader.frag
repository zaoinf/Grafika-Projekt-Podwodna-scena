...
uniform float time; // Time uniform dla animowania zmieniaj¹cego siê w czasie perlin noise (zniekszta³cenia)
uniform vec3 cameraPos;
uniform vec3 fogColor = vec3(0.2, 0.5, 0.7); // Kolor podwodnej mg³y
uniform float fogDensity = 0.05; // genstoœæ mg³y
...
void main()
{
    // Animate Perlin noise for distortion with time
